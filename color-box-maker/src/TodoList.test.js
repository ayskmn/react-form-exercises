...
function addTodo(todoList, task="submit the exercise") {
...
it("can add a todo", function() {
	...
	expect(list.getByText("submit the exercise")).toBeInTheDocument();
...
it("can edit a todo", function() {
  ...
  const editInput = list.getByDisplayValue("submit the exercise");
...
it("can delete a todo", function() {
  ...
  expect(list.queryByText("submit the exercise")).not.toBeInTheDocument();
});